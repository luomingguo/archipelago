---
title: "大偏差界：Markov、Chebyshev 与 Chernoff 界"
type: lecture
lecture: 24
tags: [concentration-inequality, markov-inequality, chebyshev-inequality, chernoff-bound]
status: complete
source: https://ocw.mit.edu/courses/6-1200j-mathematics-for-computer-science-spring-2024/resources/61200-sp24-lecture24-2024may14_mp4/
---
# Lec 24 大偏差界：Markov、Chebyshev 与 Chernoff 界

> 资料依据：[课程视频与 transcript](https://ocw.mit.edu/courses/6-1200j-mathematics-for-computer-science-spring-2024/resources/61200-sp24-lecture24-2024may14_mp4/) · [Lecture notes](https://ocw.mit.edu/courses/6-1200j-mathematics-for-computer-science-spring-2024/mit6_1200j_s24_lec24.pdf)

## TL;DR

- Markov 不等式只使用非负随机变量的期望给出上尾界；通过平移已知上下界可以得到更紧的结果。
- Chebyshev 不等式对平方偏差应用 Markov，用方差控制偏离均值至少 $c$ 个标准差的概率不超过 $1/c^2$。
- Chernoff 界利用互独立与有界性获得指数级尾界；更强的假设换来比只依赖均值或方差的界快得多的衰减。
...
::: insight
集中不等式可视为一条信息—结论梯子：只知非负性与期望时用 Markov，再知方差时用 Chebyshev，知道独立有界分量时用 Chernoff。界的强度来自额外假设，不应脱离条件比较公式。
:::
